 ...
 *
 * Built from RxJS rather than ng-idle after MOL-4412 (September 2023 incident): ng-idle's
 * interrupt sources kept the session alive on a background tab because it counted the periodic
 * balance refresh as activity, and customers came back to a still-open session after lunch. The
