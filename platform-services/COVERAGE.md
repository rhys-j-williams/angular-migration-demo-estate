...
|---|---|---|---|---|---|---|
| `bff-retail` | Node 18 / NestJS 9 | 35% | **36.4%** | 599 | Jest line (branches 32.7%) |  |
| `bff-business` | Node 18 / NestJS 9 | 30% | **34.5%** | 476 | Jest line (branches 25.9%) |  |
| `beacon-notifications` | Java 11 / Boot 2.7.18 | 25% | **29.4%** | 541 | JaCoCo line | no tests on `SequenceGate` (PLAT-1288) |
...
| `bedrock-adapter` | Java 11 / Boot 2.7.18 | 20% | **24.3%** | 567 | JaCoCo line | codec covered, MQ paths not |
| `iris-orchestrator` | Node 18 / NestJS 9 | 40% | **45.8%** | 491 | Jest line (branches 36.7%) |  |
| `documents-service` | Node 18 / Express | 25% | **27.2%** | 287 | Jest line (branches 22.6%) | statements/tax routes via smoke only (PLAT-1877) |
...
**Overall (line-weighted across the 11 measured services): 32.8%.**
JaCoCo aggregate across the seven Java services: **29.9%** over 2586 lines
