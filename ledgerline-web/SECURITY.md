# Application security standard — Ledgerline treasury

Owner: @meridian/treasury-digital. Standard reference: GIS-STD-014 Application Security Requirements for Internet
...
(`gis-appsec-intake@meridian.internal`) with the component name `ledgerline-web` and, if the finding came
