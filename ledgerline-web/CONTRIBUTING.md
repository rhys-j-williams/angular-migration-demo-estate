# Contributing to Ledgerline treasury

Owning team: @meridian/treasury-digital. Ask in `#treasury-digital` on the internal chat platform before starting anything that
...
Feature branches are `feature/LDG-1234-short-description`. Also permitted: `bugfix/`, `hotfix/`,
`spike/`, `chore/`. The pre-commit hook rejects anything else.

## Commits

`LDG-1234 imperative summary`, 72 characters or fewer, with an optional body explaining why. The
