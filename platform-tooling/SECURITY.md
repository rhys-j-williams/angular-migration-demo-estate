# Application security standard — Delivery tooling

Owner: @meridian/platform-engineering. Standard reference: GIS-STD-014 Application Security Requirements for Internet
...
(`gis-appsec-intake@meridian.internal`) with the component name `platform-tooling` and, if the finding came
